...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput pRecipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.ALEXANDRITE_HAMMER.get())
                ...
                .pattern("ABA")
                .pattern(" B ")
                .define('A', ModBlocks.ALEXANDRITE_BLOCK.get()).define('B', Items.STICK)
                .unlockedBy(getHasName(ModItems.ALEXANDRITE.get()), has(ModItems.ALEXANDRITE.get())).save(pRecipeOutput);
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.ALEXANDRITE.get(), 32)
                ...
                .save(pRecipeOutput, MinecraftMod.MOD_ID + ":alexandrite_from_magic_block");
        ...
        trimSmithing(pRecipeOutput, ModItems.ADRITE_SMITHING_TEMPLATE.get(), ResourceLocation.fromNamespaceAndPath(MinecraftMod.MOD_ID, "adrite"));
    }
