...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> ADRITE = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MinecraftMod.MOD_ID, "adrite"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.ADRITE_SMITHING_TEMPLATE.get(), ADRITE);
    }
